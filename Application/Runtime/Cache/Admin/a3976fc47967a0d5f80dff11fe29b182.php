<?php if (!defined('THINK_PATH')) exit();?><table id="AdminGroup"></table>
<script>
$.Admin.Group = {
    //组件ID
    'id' : '#AdminGroup',
    ...
    'ViewGroup' : function(){
        ...
        $(id).dialog({
            ...
            href: '<?php echo U("Group/viewGroup");?>',
            modal: true,
            width: 500,
            onClose : function(){
                $(this).dialog("destroy");
    ...
    'AddGroup' : function(){
        ...
        $(id).dialog({
            ...
            iconCls: 'fa fa-plus',
            queryParams: data,
            href: '<?php echo U("Group/addGroup");?>',
            modal: true,
            width: 500,
            onClose : function(){
                $(this).dialog("destroy");
    ...
    'EditGroup' : function(){
        ...
        $(id).dialog({
            ...
            iconCls: 'fa fa-edit',
            queryParams: data,
            href: '<?php echo U("Group/editGroup");?>',
            modal: true,
            width: 500,
            onClose : function(){
                $(this).dialog("destroy");
    ...
    'DelGroup' : function(){
        ...
        $.messager.confirm('系统提示', '此次将删除该分类与其下所有子分类<br />请慎重考虑，是否继续？', function (res) {
            if(res){
                $.Admin.del_action('<?php echo U("Group/DelGroup");?>',data);
            }
        });
    },
    ...
    'SortGroup' : function(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo U("Group/SortGroup");?>',
            data: sort_list,
            dataType:"json",
            beforeSend: function(){
